...
import { Shield, Bot, Menu, X, AlertTriangle, CheckCircle, Info, ArrowUpRight, Loader2, Send, Timer } from "lucide-react";
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          setUpdates((prev) => [{ ...newUpdate, isNew: true }, ...prev.slice(0, 5)]);
  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-background flex">
        ...
        {/* Main Content */}
        <main className="flex-1 lg:ml-80 pt-24 lg:pt-8 pb-8 px-4 lg:px-8">
          {/* Header */}
          <motion.div
